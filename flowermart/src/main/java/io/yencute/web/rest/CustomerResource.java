...
import io.yencute.repository.CustomerRepository;
import io.yencute.repository.search.CustomerSearchRepository;
...
/**
 * REST controller for managing {@link io.yencute.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional

...
export class InfoCustomerComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-info-customer div table .btn-danger'));
  title = element.all(by.css('jhi-info-customer div h2#page-heading span')).first();
...
export class InfoCustomerUpdatePage {
  pageTitle = element(by.id('jhi-info-customer-heading'));
...
export class InfoCustomerDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-infoCustomer-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-infoCustomer'));

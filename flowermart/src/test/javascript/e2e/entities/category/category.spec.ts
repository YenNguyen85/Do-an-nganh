...
describe('Category e2e test', () => {
  ...
  it('should load Categories', async () => {
    ...
    expect(await categoryComponentsPage.getTitle()).to.eq('flowermartApp.category.home.title');
  ...
  it('should load create Category page', async () => {
    ...
    expect(await categoryUpdatePage.getPageTitle()).to.eq('flowermartApp.category.home.createOrEditLabel');
  ...
  it('should delete last Category', async () => {
    ...
    expect(await categoryDeleteDialog.getDialogTitle()).to.eq('flowermartApp.category.delete.question');

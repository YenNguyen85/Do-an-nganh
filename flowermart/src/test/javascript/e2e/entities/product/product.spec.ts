...
describe('Product e2e test', () => {
  ...
  it('should load Products', async () => {
    ...
    expect(await productComponentsPage.getTitle()).to.eq('flowermartApp.product.home.title');
  ...
  it('should load create Product page', async () => {
    ...
    expect(await productUpdatePage.getPageTitle()).to.eq('flowermartApp.product.home.createOrEditLabel');
  ...
  it('should delete last Product', async () => {
    ...
    expect(await productDeleteDialog.getDialogTitle()).to.eq('flowermartApp.product.delete.question');

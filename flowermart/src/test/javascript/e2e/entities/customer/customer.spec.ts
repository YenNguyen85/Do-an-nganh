...
describe('Customer e2e test', () => {
  ...
  it('should load Customers', async () => {
    ...
    expect(await customerComponentsPage.getTitle()).to.eq('flowermartApp.customer.home.title');
  ...
  it('should load create Customer page', async () => {
    ...
    expect(await customerUpdatePage.getPageTitle()).to.eq('flowermartApp.customer.home.createOrEditLabel');
  ...
  it('should delete last Customer', async () => {
    ...
    expect(await customerDeleteDialog.getDialogTitle()).to.eq('flowermartApp.customer.delete.question');

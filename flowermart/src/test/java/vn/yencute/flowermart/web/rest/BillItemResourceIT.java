...
import vn.yencute.flowermart.domain.enumeration.BillItemStatus;
/**
...
public class BillItemResourceIT {
     ...
     *
     * @see vn.yencute.flowermart.repository.search.BillItemSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createBillItem() throws Exception {
        ...
        // Create the BillItem
        restBillItemMockMvc.perform(post("/api/bill-items").with(csrf())
    ...
    public void updateBillItem() throws Exception {
        ...
        restBillItemMockMvc.perform(put("/api/bill-items").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteBillItem() throws Exception {
        ...
        // Delete the billItem
        restBillItemMockMvc.perform(delete("/api/bill-items/{id}", billItem.getId()).with(csrf())

...
public class NewsAndEventResourceIT {
     ...
     *
     * @see vn.yencute.flowermart.repository.search.NewsAndEventSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createNewsAndEvent() throws Exception {
        ...
        restNewsAndEventMockMvc.perform(post("/api/news-and-events").with(csrf())
    ...
    public void updateNewsAndEvent() throws Exception {
        ...
        restNewsAndEventMockMvc.perform(put("/api/news-and-events").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteNewsAndEvent() throws Exception {
        ...
        restNewsAndEventMockMvc.perform(delete("/api/news-and-events/{id}", newsAndEvent.getId()).with(csrf())

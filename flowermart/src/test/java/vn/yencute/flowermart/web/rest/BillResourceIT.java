...
import vn.yencute.flowermart.repository.BillRepository;
import vn.yencute.flowermart.repository.search.BillSearchRepository;
...
import vn.yencute.flowermart.domain.enumeration.OrderStatus;
/**
...
public class BillResourceIT {
     ...
     *
     * @see vn.yencute.flowermart.repository.search.BillSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createBill() throws Exception {
        ...
        // Create the Bill
        restBillMockMvc.perform(post("/api/bills").with(csrf())
    ...
    public void updateBill() throws Exception {
        ...
        restBillMockMvc.perform(put("/api/bills").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteBill() throws Exception {
        ...
        // Delete the bill
        restBillMockMvc.perform(delete("/api/bills/{id}", bill.getId()).with(csrf())

...
import vn.yencute.flowermart.repository.ContactInfoRepository;
import vn.yencute.flowermart.repository.search.ContactInfoSearchRepository;
...
public class ContactInfoResourceIT {
     ...
     *
     * @see vn.yencute.flowermart.repository.search.ContactInfoSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createContactInfo() throws Exception {
        ...
        restContactInfoMockMvc.perform(post("/api/contact-infos").with(csrf())
    ...
    public void updateContactInfo() throws Exception {
        ...
        restContactInfoMockMvc.perform(put("/api/contact-infos").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteContactInfo() throws Exception {
        ...
        restContactInfoMockMvc.perform(delete("/api/contact-infos/{id}", contactInfo.getId()).with(csrf())
